...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/danathar/kinoite-zfs:stable
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/danathar/kinoite-zfs:stable
  ```
...
The `stable` tag is provided via `alt-tags` in `recipe.yml` and points to the pinned Fedora major version build.
